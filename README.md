...
| [⚡ Manifest](agents/devops/manifest/) | AI gateway, intelligent model routing, cost tracking | When you want to route OpenClaw queries across 300+ models and cut LLM costs by up to 70% | [View](agents/devops/manifest/SOUL.md) | [Deploy →](https://crewclaw.com/create-agent?role=software-engineer) |
